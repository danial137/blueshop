...
// Variable: SALE_QUERY
// Query: *[_type=='sale'] | order(nam asc)|order(name asc)
...
// Query: *[_type=='product'] | order(nam asc)|order(name asc)
...
// Query: *[_type=='product' && slug.current==$slug ] | order(name)[0]
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type=='product' && slug.current==$slug ] | order(name)[0]": PRODUCT_BY_SLUG_RESULT;
    "*[_type=='product'&& name match $searchParams] | order(name asc)": PRODUCT_SEARCH_QUERY_RESULT;
  }
}
